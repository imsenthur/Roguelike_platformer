...
public class GameCamera : MonoBehaviour
{
    ...
    public void FixedUpdate()
    {
        ...
        if (mPlayer == null)
            mPlayer = mPlayerTransform.GetComponent<Bot>();
        ...
        if (cameraPos.x < mMap.position.x + Camera.main.pixelWidth * 0.167f - Map.cTileSize / 2 + cOuterVisibilityX * Map.cTileSize)
            cameraPos.x = mMap.position.x + Camera.main.pixelWidth * 0.167f - Map.cTileSize / 2 + cOuterVisibilityX * Map.cTileSize;
        ...
        if (cameraPos.y < mMap.position.y + Camera.main.pixelHeight * 0.167f - Map.cTileSize / 2 + cOuterVisibilityX * Map.cTileSize)
            cameraPos.y = mMap.position.y + Camera.main.pixelHeight * 0.167f - Map.cTileSize / 2 + cOuterVisibilityX * Map.cTileSize;
